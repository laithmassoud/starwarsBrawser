  ...
  people.results.forEach(function(person) {
    ...
    <header>
      <h1>
        ...
        <button class="button">GIMME THE HOMEWORLD DIGGA</button>
      </h1>
    </header>
    <div>
      <ul>
...
function renderPlanets(planets) {
  ...
  planets.results.forEach(function(object) {
    var sectionElement = document.createElement('section');
  ...
  species.results.forEach(function(space) {
    ...
    <div>
      <ul>
        ...
        <li>
          <span class="label">Eye Color:</span>
          <span class="value">${space.eye_color}</span>
        </li>
        <li>
          <span class="label">Skin Color:</span>
          <span class="value">${space.skin_color}</span>
        </li>
        <li>
          <span class="label">Hair Color:</span>
          <span class="value">${space.hair_color}</span>
        </li>
  
        <li>
          <span class="label">Mass:</span>
          <span class="value">${space.mass}kg</span>
        </li>
      </ul>
    </div>
    `;
